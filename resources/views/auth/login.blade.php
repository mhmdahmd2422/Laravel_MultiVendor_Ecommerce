                                ...
                                <form method="post" action="{{ route('login') }}">
                                    ...
                                    <div class="wsus__login_save">
                                        <div class="form-check form-switch">
                                            <input for="remember_me" class="form-check-input" type="checkbox" name="remember"
                        ...
                        <div class="tab-pane fade" id="pills-profiles" role="tabpanel"
                            ...
                            <div class="wsus__login">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="wsus__login_input">
                                        <i class="fas fa-user-tie"></i>
                                        <input id="name" name="name" type="text" value="{{old('name')}}" placeholder="Name" autocomplete="name">
                                    </div>
                                    <div class="wsus__login_input">
                                        <i class="far fa-envelope"></i>
                                        <input id="email" name="email" type="email" value="{{old('email')}}" placeholder="Email" autocomplete="username">
                                    </div>
                                    <div class="wsus__login_input">
                                        <i class="fas fa-key"></i>
